...
This project uses [uv](https://docs.astral.sh/uv/) for Python environment and package management. Install uv first if you don't already have it:
...
- **Weights & Biases**: `uv pip install wandb`
- **TensorBoard**: `uv pip install tensorboard` (included with PyTorch)
- **Comet ML**: `uv pip install comet-ml`
